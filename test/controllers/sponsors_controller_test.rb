...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { active: @sponsor.active, logo_link: @sponsor.logo_link, name: @sponsor.name, sponsor_url: @sponsor.sponsor_url }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { active: @sponsor.active, logo_link: @sponsor.logo_link, name: @sponsor.name, sponsor_url: @sponsor.sponsor_url }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
